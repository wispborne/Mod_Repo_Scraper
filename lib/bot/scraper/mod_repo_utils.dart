...
class ModRepoUtils {
  static const List<List<String>> authorAliases = [
    ...
    ["theDragn", "iryx.gay"],
    // "AudaxI" ends in a capital i, "Audaxl" in a lowercase L. Same person,
    // and the two are impossible to tell apart in most fonts.
    ["Audax", "Audaxl", "AudaxI"],
    ["Pogre", "noof"],
    ["lord_dalton", "Epta Consortium", "Dalton"],
    ["Genir", "halke1986"],
