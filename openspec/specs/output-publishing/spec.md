...
Push the current output files to the public GitHub repo TriOS reads, on demand from the browser, as an ordinary manager job — so fresh output does not have to wait for the twice-a-day cron script.
