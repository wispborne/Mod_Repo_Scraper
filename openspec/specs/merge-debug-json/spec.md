...
Keep a record of how a merge reached its answer — what matched what, what was thrown away and why — as JSON the viewer can read, so a change to the matching rules can be judged instead of guessed at.
## Requirements
