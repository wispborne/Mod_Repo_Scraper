...
Take every piece of work as a plain request saying exactly what to do, run them one at a time, and allow them to be cancelled — so the command line and the website share one engine.
## Requirements
